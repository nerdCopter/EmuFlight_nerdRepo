...
> Source: `src/main/interface/settings.c`, `src/main/interface/cli.c` | Generated: 2026-09-05 | Commit: `5b9312172` | Firmware: `0.4.3` | MSP: `0.1.54`
...
| `rc_smoothing_input_type` | uint8 | master | `PT1`, `1EURO`, `PT2`, `2EURO` | `USE_RC_SMOOTHING_FILTER` |
