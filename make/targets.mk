...
$(error Target '$(TARGET)' has not specified a valid STM group, must be one of F1, F3, F405, F411, F7x5 or H7. Have you prepared a valid target.mk?)
endif
