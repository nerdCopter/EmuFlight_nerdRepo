...
* Read and remove this from PR message.

* Please follow the coding style guidlines: https://github.com/cleanflight/cleanflight/blob/master/docs/development/CodingStyle.md   (But i hate "Braces after function declarations to Next line".)
