...
static OSD_Entry cmsx_menuRFTPAEntries[] =
{
    ...
    { "0", OME_UINT8, NULL,                     &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[0], 0,  250,  1}, 0 },
    { "12.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[1], 0,  250,  1}, 0 },
    { "25", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[2], 0,  250,  1}, 0 },
    { "37.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[3], 0,  250,  1}, 0 },
    { "50", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[4], 0,  250,  1}, 0 },
    { "62.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[5], 0,  250,  1}, 0 },
    { "75", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[6], 0,  250,  1}, 0 },
    { "87.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[7], 0,  250,  1}, 0 },
    { "100", OME_UINT8, NULL,                   &(OSD_UINT8_t)  { &rateProfile.tpaKpCurve[8], 0,  250,  1}, 0 },
    { "-- KI --", OME_Label, NULL, NULL, 0 },
    { "0", OME_UINT8, NULL,                     &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[0], 0,  250,  1}, 0 },
    { "12.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[1], 0,  250,  1}, 0 },
    { "25", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[2], 0,  250,  1}, 0 },
    { "37.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[3], 0,  250,  1}, 0 },
    { "50", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[4], 0,  250,  1}, 0 },
    { "62.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[5], 0,  250,  1}, 0 },
    { "75", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[6], 0,  250,  1}, 0 },
    { "87.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[7], 0,  250,  1}, 0 },
    { "100", OME_UINT8, NULL,                   &(OSD_UINT8_t)  { &rateProfile.tpaKiCurve[8], 0,  250,  1}, 0 },
    { "-- KD --", OME_Label, NULL, NULL, 0 },
    { "0", OME_UINT8, NULL,                     &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[0], 0,  250,  1}, 0 },
    { "12.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[1], 0,  250,  1}, 0 },
    { "25", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[2], 0,  250,  1}, 0 },
    { "37.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[3], 0,  250,  1}, 0 },
    { "50", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[4], 0,  250,  1}, 0 },
    { "62.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[5], 0,  250,  1}, 0 },
    { "75", OME_UINT8, NULL,                    &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[6], 0,  250,  1}, 0 },
    { "87.5", OME_UINT8, NULL,                  &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[7], 0,  250,  1}, 0 },
    { "100", OME_UINT8, NULL,                   &(OSD_UINT8_t)  { &rateProfile.tpaKdCurve[8], 0,  250,  1}, 0 },
